...
import 'chat_details_overlay_copy_model.dart';
export 'chat_details_overlay_copy_model.dart';

class ChatDetailsOverlayCopyWidget extends StatefulWidget {
  const ChatDetailsOverlayCopyWidget({
    super.key,
  ...
  @override
  State<ChatDetailsOverlayCopyWidget> createState() =>
      _ChatDetailsOverlayCopyWidgetState();
}

class _ChatDetailsOverlayCopyWidgetState
    extends State<ChatDetailsOverlayCopyWidget> {
  late ChatDetailsOverlayCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChatDetailsOverlayCopyModel());
  }
