...
class _AuthForgotPasswordWidgetState extends State<AuthForgotPasswordWidget> {
  ...
  void initState() {
    ...
    _model.emailAddressForgotPasswordTextController ??= TextEditingController();
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                controller: _model
                                    .emailAddressForgotPasswordTextController,
                                focusNode:
                                    _model.emailAddressForgotPasswordFocusNode,
                                autofocus: false,
                                obscureText: false,
                  ...
                  if (!(isWeb
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          if (_model.emailAddressForgotPasswordTextController
                              .text.isEmpty) {
                          ...
                          await authManager.resetPassword(
                            email: _model
                                .emailAddressForgotPasswordTextController.text,
                            context: context,
                          );
                        },
                        text: 'Send Link',
